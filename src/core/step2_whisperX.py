...
try:
    ...
    def demucs_main():
        pass  # No-op if demucs not available
...
def transcribe_audio(audio_file: str, start: float, end: float) -> Dict:
    ...
    try:
        ...
        model = whisperx.load_model(model_name, device, compute_type=compute_type, language=whisper_language, vad_options=vad_options, asr_options=asr_options, download_root=MODEL_DIR, local_files_only=True)
